/*
本脚本适用于按照 DiDi.js 正确配置但无法获取 token 且"滴滴出行"主页右上角有"天天领福利"的用户，用此脚本获取 token 后请用回 DiDi.js 进行定时任务。
请先按下述方法进行配置，进入"滴滴出行"，点击右上角"天天领福利"，若弹出"首次写入滴滴出行 Token 成功"即可正常食用，其他提示或无提示请发送日志信息至 issue。
