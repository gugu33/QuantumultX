/*
"欧可林"每日红包得积分，晚上九点，此脚本为使用 Oclean_mini.js 者使用。
0 0 21 * * *
...
const CheckinURL = 'https://mall.oclean.com/API/VshopProcess.ashx?action=GrabEveryDayPoint&redId=2&clientType=5&client=5&openId='
